---
title: "itunes"
description: "A command line for itunes."
heroTitle: "itunes, from the command line"
heroLead: "A command line for itunes. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
itunes links <path>           # the pages it links to, each addressable
itunes serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading itunes by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address itunes as
  `itunes://` URIs and follow links across sites. See
