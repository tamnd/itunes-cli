...
Most of these come down to network reality or how itunes serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

itunes rate-limits like any public site. itunes already paces
...
Where a surface is gated, itunes reads a cookie or token you supply
...
`itunes`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what itunes actually did
