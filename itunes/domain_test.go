...
// HTTP behaviour is covered in itunes_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "itunes://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("itunes", "about")
	if err != nil || got.String() != "itunes://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want itunes://page/about", got.String(), err)
	}
}
